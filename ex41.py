...
def central_corridor():
    ...
    ***** ***** ***** ***** ***** ***** ***** ***** ***** *****
    ...
    from the Weapons Armory, put it in the bridge, and blow the
    ...
    evil clown costume fowing around his hate filled body. He's 
    blocking the door to the Amory and about to pull a weapon to 
    blast you.
...
ROOMS = {
    ...
    'laser_weapn_armory': laser_weapn_armory,
